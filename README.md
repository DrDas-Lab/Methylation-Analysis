...
| `scripts/04_ModuleScore.R` | Calculates AML differentiation module scores and generates ordered trajectory samples. Uses Seurat (v5.3.0) for AddModuleScore and PCA. | Inputs: <br/> `output/CIBERSORT_mixture_RPM.txt` <br/> `output/AML_dominant_cell_state.csv` <br/> `input/AMLCellType_Genesets.gmt` <br/><br/> Outputs: <br/> `output/AML_ModuleScores.csv` <br/> `output/AML_ModuleScore_PCA.csv` <br/> `output/AML_Trajectory_Ordering.csv` |

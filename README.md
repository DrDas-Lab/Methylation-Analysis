...
| --- | --- | --- |
| `scripts/01_preprocess_counts.R` | Perform standard RNA-seq preprocessing by converting raw sequencing counts into a normalized, log-transformed expression matrix | Inputs: <br/> `input/beataml_waves1to4_counts_dbgap.txt` <br/><br/> Outputs: <br/> `output/BAML_Normalized.txt` |

...
# ---------------------------------------------------------
dominant_df <- read.csv("temp_output/AML_dominant_cell_state.csv")
...
write.csv(
  module_scores,
  "temp_output/AML_ModuleScores.csv"
)
...
write.csv(
  pca_df,
  "temp_output/AML_ModuleScore_PCA.csv"
)
...
write.csv(
  trajectory_df,
  "temp_output/AML_Trajectory_Ordering.csv",
  row.names = FALSE
)
